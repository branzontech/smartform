  ...
  const renderQuestionContent = () => {
      ...
      switch (questionType) {
        ...
        case 'multifield':
          return <Multifield 
            ...
            readonly={true}
            handleLabelChange={handleMultifieldLabelChange}
    ...
    if (questionType === "clinical") {
      return (
        <div className="mt-4 space-y-3">
          <div>
            <label className="block text-sm text-gray-600 mb-1">Datos clínicos:</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm text-gray-600 mb-1">Información detallada:</label>
            <textarea
