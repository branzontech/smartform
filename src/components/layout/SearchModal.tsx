        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-border/50">
              <h2 className="text-xl font-semibold text-foreground">Buscar</h2>
              <button
                onClick={() => {
                  onClose();
                  setSearchQuery("");
            ...
            <div className="px-6 py-4 border-t border-border/50 bg-muted/30">
              <p className="text-xs text-muted-foreground text-center">
                Presiona <kbd className="px-1.5 py-0.5 rounded bg-muted text-xs font-mono">ESC</kbd> para cerrar · <kbd className="px-1.5 py-0.5 rounded bg-muted text-xs font-mono">⌘K</kbd> para abrir
              </p>
            </div>
          </motion.div>
        </motion.div>
